...
class ConformalModel(nn.Module):
    def __init__(self, model, calib_loader, alpha, kreg=None, lamda=None, randomized=False, allow_zero_sets=True, pct_paramtune = 0.3, batch_size=32, lamda_criterion='size'):
...
class ConformalModelLogits(nn.Module):
    def __init__(self, model, calib_loader, alpha, kreg=None, lamda=None, randomized=False, allow_zero_sets=True, naive=False, LAC=False, pct_paramtune = 0.3, batch_size=32, lamda_criterion='size'):
